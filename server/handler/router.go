...
func InitRouter() http.Handler {
	// middleware check token first (authentication) before sending it to certain handlers
	// NOTE: not putting it in front of dispatcher (router) -> not all handlers need auth/authr
